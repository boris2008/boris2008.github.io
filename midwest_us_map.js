...
var svg = d3.select("#us_map")
  ...
  .text("MidWest States Revenue"); // Set the text content of the title
// Add tooltip div
...
Promise.all([
  ...
  // Filter and color the states in the west region
    // Filter and color the states in the west region
  var RegionFips = ['17','18','19','20','26','27','38','39','46','55','31','29'];
  ...
  .style("fill", function(d){
    return RegionFips.includes(d.id)? "blue" : "gray";
  })
